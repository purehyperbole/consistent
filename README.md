...
Forked from the excellent [github.com/buraksezer/consistent](github.com/buraksezer/consistent). Modified to provide:

- [x] Lock Free calls on for all operations
- [x] Generics
